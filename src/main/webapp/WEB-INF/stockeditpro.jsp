...
<body>
	<div class="container">
		...
		<div class="content">
			<form action="stockeditpro" method="post">
			<input type="hidden" name="userid" value="${stock.userid}"/>
				<table>
					<tr>
						<td>Bloodbank-Id:</td>
						<td><input class="input" type="number" id="bloodbankid" value="${stock.bloodbankid}"
							name="bloodbankid" required></td>
						<td><span class="error" id="bloodbankidError"></span></td>
					</tr>
					<tr>
						<td>Name:</td>
						<td><input class="input" type="text" id="fname" name="name" value="${stock.name}"
							required></td>
						<td><span class="error" id="fnameError"></span></td>
					</tr>
					<tr>
						<td>DOB:</td>
						<td><input class="input" type="date" id="dob" name="dob" value="${stock.dob}"
							required></td>
						<td><span class="error" id="dobError"></span></td>
					</tr>
					<tr>
						<td>Contact no:</td>
						<td><input class="input" type="tel" id="contact" value="${stock.contact}"
